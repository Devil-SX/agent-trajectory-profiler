...
export async function setupMockApi(page: Page) {
  const mockAnalyticsOverview = {
    ...
    day_model_coverage_seconds: 7200,
    day_tool_coverage_seconds: 5400,
    day_user_coverage_seconds: 3600,
    night_model_coverage_seconds: 1800,
    night_tool_coverage_seconds: 1200,
    night_user_coverage_seconds: 600,
  ...
  const mockRuntimePlane = {
    ...
    coverage_total_window_seconds: mockAnalyticsOverview.coverage_total_window_seconds,
    coverage_day_window_seconds: mockAnalyticsOverview.coverage_day_window_seconds,
    coverage_night_window_seconds: mockAnalyticsOverview.coverage_night_window_seconds,
    day_model_coverage_seconds: mockAnalyticsOverview.day_model_coverage_seconds,
    day_tool_coverage_seconds: mockAnalyticsOverview.day_tool_coverage_seconds,
    day_user_coverage_seconds: mockAnalyticsOverview.day_user_coverage_seconds,
    night_model_coverage_seconds: mockAnalyticsOverview.night_model_coverage_seconds,
    night_tool_coverage_seconds: mockAnalyticsOverview.night_tool_coverage_seconds,
    night_user_coverage_seconds: mockAnalyticsOverview.night_user_coverage_seconds,
